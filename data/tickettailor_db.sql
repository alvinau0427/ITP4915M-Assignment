...
CREATE DATABASE IF NOT EXISTS `tickettailor_db` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `tickettailor_db`;
-- --------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `attractionbooking` (
...
CREATE TABLE IF NOT EXISTS `attractionprice` (
  `AttractName` varchar(40) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `corganizer` (
...
CREATE TABLE IF NOT EXISTS `cruise` (
  ...
  `RefPrice` decimal(8,2) DEFAULT '0.00',
...
CREATE TABLE IF NOT EXISTS `cruisebooking` (
...
INSERT INTO `driver` (`DriverID`, `StaffName`, `Gender`, `Center`, `Email`, `Pass`, `Position`, `Salary`, `Ctype`, `Late`) VALUES
('ho1', 'Ho Yin', 'M', 'HQ', 'ho@tt.com', '123456', 'Driver', 900, 'Driver', 5),
('kwong1', 'Kwong Johnny', 'M', 'HQ', 'kwong@tt.com', '123456', 'Driver', 800, 'Driver', 1),
('lam1', 'Lam Sze Kit', 'M', 'HQ', 'lam@tt.com', '123456', 'Driver', 750, 'Driver', 0),
('lam2', 'Lam Chris', 'M', 'HQ', 'chris@tt.com', '123456', 'Driver', 650, 'Driver', 1),
('law1', 'Law Ming Fai', 'M', 'HQ', 'law@tt.com', '123456', 'Driver', 800, 'Driver', 2),
('wu1', 'Wu Richard', 'M', 'HQ', 'weu@tt.com', '123456', 'Driver', 850, 'Driver', 0);
...
CREATE TABLE IF NOT EXISTS `equipmentlist` (
  ...
  `EquipBookPrice` decimal(5,2) DEFAULT '0.00'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `flightbooking` (
  ...
  `AdultPrice` decimal(8,2) DEFAULT '0.00',
  `ChildPrice` decimal(8,2) DEFAULT '0.00',
  `InfantPrice` decimal(8,2) DEFAULT '0.00',
  `OrderDate` date DEFAULT NULL,
  `OrderBy` varchar(10) DEFAULT NULL,
  `CustID` char(4) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `flightclass` (
  ...
  `Price_Adult` decimal(7,2) DEFAULT '0.00',
  `Price_Children` decimal(7,2) DEFAULT '0.00',
  `Price_Infant` decimal(7,2) DEFAULT '0.00',
...
INSERT INTO `hotelbooking` (`HotelRoomID`, `CustID`, `NumNight`, `NumRoom`, `Price`, `OrderDate`, `OrderBy`, `Checkin`, `Checkout`) VALUES
(1, 'C001', 3, 1, '7030.83', '2016-06-02', 'fai1', '2016-07-01', '2016-07-04'),
(3, 'C003', 1, 1, '2493.20', '2016-05-13', 'han1', '2016-07-11', '2016-07-12'),
(6, 'C003', 4, 1, '21940.16', '2016-05-12', 'fan1', '2016-07-22', '2016-07-26'),
(11, 'C006', 10, 1, '16552.00', '2016-06-01', 'cheong1', '2016-08-01', '2016-08-11'),
(16, 'C007', 1, 1, '1397.99', '2016-05-22', 'cheong1', '2016-07-21', '2016-07-22'),
(20, 'C007', 3, 1, '4936.50', '2016-04-24', 'tak1', '2016-07-14', '2016-07-17'),
(25, 'C007', 3, 1, '3663.06', '2016-04-08', 'yum1', '2016-06-21', '2016-06-24');
...
CREATE TABLE IF NOT EXISTS `indirect` (
  `FlightID` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `package` (
  ...
  `Adult_price` int(11) DEFAULT '0.00',
  `Child_price` int(11) DEFAULT '0.00'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `staff` (`StaffID`, `StaffName`, `Gender`, `Center`, `email`, `Pass`, `Position`, `Salary`, `Ctype`, `Late`, `SImage`) VALUES
('admin', 'Yu Kwok Ho', 'M', 'AM01', 'yu@tt.com', 'admin', 'Administrator', '10000.00', 'Admin', 1, 'Yu.jpg'),
('cheong1', 'Lam Sin Cheong', 'M', 'ST02', 'cheong@tt.com', '123456', 'Customer Service Officer', '13500.00', 'Officer', 3, 'Cheong.jpg'),
('fai1', 'Siu Yao Fai', 'M', 'MK01', 'fai@tt.com', '123456', 'Customer Service Officer', '18800.00', 'Officer', 5, 'Fai.jpg'),
('fan1', 'Tang Cheuk Fan', 'M', 'ST01', 'fan@tt.com', '123456', 'Customer Service Officer', '23000.00', 'Officer', 20, 'Fan.jpg'),
('han1', 'Chan Yuen Han', 'F', 'TS01', 'han@tt.com', '123456', 'Customer Service Officer', '22500.00', 'Officer', 3, 'Han.jpg'),
('kam1', 'Yuk Siu Kam', 'F', 'ST01', 'kam@tt.com', '123456', 'Center Manager', '29000.00', 'Officer', 5, 'Kam.jpg'),
('kuen1', 'Leung Siu Kuen', 'M', 'TW01', 'kuen@tt.com', '123456', 'Center Manager', '30000.00', 'Officer', 5, 'Kuen.jpg'),
('lung1', 'Kam Hiu Lung', 'M', 'TS01', 'lung@tt.com', '123456', 'Customer Service Officer', '16600.00', 'Officer', 8, 'Lung.jpg'),
('ming1', 'Cheung Ming', 'M', 'MK01', 'ming@tt.com', '123456', 'Customer Service Officer', '12500.00', 'Officer', 10, 'Ming.jpg'),
('ning1', 'Leung Chin Ning', 'F', 'TW01', 'ning@tt.com', '123456', 'Customer Service Officer', '18200.00', 'Officer', 25, 'Ning.jpg'),
('on1', 'Lam Hin On', 'M', 'ST02', 'on@tt.com', '123456', 'Center Manager', '28500.00', 'Officer', 4, 'On.jpg'),
('shun1', 'Chan Tai Shun', 'M', 'TS01', 'shun@tt.com', '123456', 'Customer Service Officer', '22000.00', 'Officer', 6, 'Shun.jpg'),
('tak1', 'Au Siu Tak', 'M', 'MK01', 'tak@tt.com', '123456', 'Customer Service Officer', '12800.00', 'Officer', 6, 'Tak.jpg'),
('yum1', 'Chan See Yum', 'F', 'ST01', 'yum@tt.com', '123456', 'Customer Service Officer', '14000.00', 'Officer', 2, 'yum.jpg');
...
CREATE TABLE IF NOT EXISTS `vehiclebooking` (
  ...
  `DriverRosterID` int(11) DEFAULT NULL,
  `DriverCost` int(11) DEFAULT NULL,
  `VehicleBookPrice` decimal(5,2) DEFAULT '0.00'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `vehiclebooking` (`VehicleBookingID`, `VehicleID`, `AttractionBookingID`, `BookDay`, `OrderDate`, `OrderBy`, `PickupDate`, `DropoffDate`, `DriverRosterID`, `DriverCost`, `VehicleBookPrice`) VALUES
(1, 'car06', 1, 1, '2015-11-14', 'fai1', '2015-11-20', '2015-11-20', NULL, NULL, '0.00');
...
ALTER TABLE `hotelbooking`
  ADD PRIMARY KEY (`HotelRoomID`,`CustID`),
  ADD KEY `hotelbooking_fk1_idx` (`OrderBy`),
...
ALTER TABLE `vehiclebooking`
  ...
  ADD KEY `vehiclebooking_fk3` (`AttractionBookingID`),
  ADD KEY `vehiclebooking_fk2` (`OrderBy`),
  ADD KEY `vehiclebooking_fk5` (`DriverRosterID`);
...
--
ALTER TABLE `attractionprice`
  ADD CONSTRAINT `attractionprice_fk1` FOREIGN KEY (`AttractName`) REFERENCES `attraction` (`AttractName`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- 資料表的 Constraints `cruise`
--
ALTER TABLE `cruise`
  ADD CONSTRAINT `cruise_fk1` FOREIGN KEY (`OrganID`) REFERENCES `corganizer` (`OrganID`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `hotelbooking`
  ADD CONSTRAINT `hotelbooking_fk1` FOREIGN KEY (`OrderBy`) REFERENCES `staff` (`StaffID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `hotelbooking_fk2` FOREIGN KEY (`CustID`) REFERENCES `customer` (`CustID`),
  ADD CONSTRAINT `hotelbooking_fk3` FOREIGN KEY (`HotelRoomID`) REFERENCES `hotel_room` (`Hotel_roomID`);
...
ALTER TABLE `vehiclebooking`
  ...
  ADD CONSTRAINT `vehiclebooking_fk2` FOREIGN KEY (`OrderBy`) REFERENCES `staff` (`StaffID`),
  ADD CONSTRAINT `vehiclebooking_fk3` FOREIGN KEY (`AttractionBookingID`) REFERENCES `attractionbooking` (`AttractionBookingID`),
  ADD CONSTRAINT `vehiclebooking_fk5` FOREIGN KEY (`DriverRosterID`) REFERENCES `driverroster` (`DriverRosterID`);
